                        ...
                        <div class="col-lg-6 align-self-center">
                            <form id="contact" action="" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">                 
                                        <input name="firstname" class="col-lg-6" type="text" id="first-name" placeholder="First Name*" required>               
                                    </div>
                                    <div class="col-lg-6">                
                                        <input name="lastname" class="col-lg-6" type="text" id="last-name" placeholder="Last Name*" required>                           
                                    </div>
                                    <div class="col-lg-6">                       
                                        <input name="email" class="col-lg-6" type="text" id="email" pattern="[^ @]*@[^ @]*" placeholder="Your Email" required>                        
                                    </div>
                                    <div class="col-lg-6">                         
                                        <input name="subject" class="col-lg-6" type="text" id="subject" placeholder="Subject*" required>                        
                                    </div>
                                    <div class="col-lg-12">                           
                                        <textarea name="message" type="text" class="form-control" id="message" placeholder="Message" required></textarea>                          
                                    </div>
                                    <div class="col-lg-12">
                                        <button type="submit" id="form-submit" class="main-button " name="button" value="Send Message">Send</button>
