          ...
          <div class="row">
              ...
              <div class="col-lg-6">
                  <div class="left-image">
                      <img src="<?= $config['base']['url']?>assets/images/explore-work-left-image.jpg" alt="Interior Design Work">
                  </div>
              </div>
              <div class="col-lg-6">
              ...
              <div class="col-lg-4">
                  <div class="right-image">
                      <div class="thumb">
                          ...
                          <img src="<?= $config['base']['url']?>assets/images/whats-trending-item-image.jpg" alt="">
                      </div>
                  </div>
              </div>
          </div>
              ...
              <div class="col-lg-6 left-form">
                  <form id="contact" action="" method="post">
                      <div class="row">
                          ...
                          <div class="col-lg-12">
                              <button type="submit" id="form-submit" class="main-button " name="button">Send Message</button>                            
                          </div>
                      </div>
                  </form>
              </div>
